frase = 'aaaaooo' # input('Digite uma frase: ')
...
while i < len(frase): # enquanto o índice for menor que o tamanho da string
    ...
    qtd_atual = frase.count(letra_atual) # conta quantas vezes a letra atual apareceu na frase

    if qtd_apareceu_mais_vezes <= qtd_atual: # se a quantidade da letra que apareceu mais vezes for menor ou igual à quantidade da letra atual
        qtd_apareceu_mais_vezes = qtd_atual # atualiza a quantidade da letra que apareceu mais vezes
